...
describe Backends::Msazure::Network do
  ...
  let(:dummy_w_opts) do
    ...
    Backends::Msazure::Network.new nil, opts, nil, nil, dalli
  end
  ...
  describe '#new' do
    it 'fails to instantiate without a fixtures_dir' do
      expect { Backends::Msazure::Network.new nil, nil, nil, nil, dalli }.to raise_error
    end
  end
end
